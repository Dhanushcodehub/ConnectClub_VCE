  ...
  return (
    <div>
        <header className="px-8 py-6 border-b border-white/5 flex items-center justify-between">
          ...
          <Link href="/member/projects/create" className="bg-primary text-white px-4 py-2 rounded-lg font-medium flex items-center hover:bg-primary/90 transition-colors">
                  ...
                  projects.map((project) => (
                    <tr key={project.id} className="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className="px-6 py-4 text-right">
                        <Link href={`/member/projects/${project.id}/edit`} className="p-2 text-white/50 hover:text-white transition-colors inline-flex" aria-label="Edit">
